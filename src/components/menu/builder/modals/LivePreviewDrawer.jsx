                    ...
                    <div className="space-y-4">
                      {catItems.map(item => (
                        <div key={item.id} className="flex gap-3">
                          ...
                          {item.imageUrl ? (
                            <div className="w-20 h-20 rounded-xl overflow-hidden shrink-0 border border-border shadow-sm">
                              <img src={item.imageUrl} alt={item.name} className="w-full h-full object-cover" />
                            </div>
                          ) : (
                            <div className="w-20 h-20 rounded-xl bg-muted/50 border border-dashed border-border flex items-center justify-center shrink-0">
