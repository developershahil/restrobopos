      ...
      <div className="p-5">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                ...
                {filterMode === 'outlet' ? <Store className="w-5 h-5" /> : <Tag className="w-5 h-5" />}
              </div>
              <div>
        ...
        {results.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {filterMode === 'outlet'
              ? results.map(offer => (
                  <div key={offer.id} className="flex items-center gap-3 p-4 rounded-xl border border-border hover:border-primary/30 hover:bg-primary/5 transition-all">
              ...
              : results.map(outlet => (
                  <div key={outlet.id} className="flex items-center gap-3 p-4 rounded-xl border border-border hover:border-primary/30 hover:bg-primary/5 transition-all">
