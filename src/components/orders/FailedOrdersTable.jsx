  ...
  return (
    <div className="flex h-full bg-background overflow-hidden relative">
      ...
      <div className={`flex-1 flex flex-col h-full transition-all duration-300 ${selectedOrder ? 'w-1/2 opacity-50 md:opacity-100' : 'w-full'}`}>
        ...
        <div className="p-4 md:p-6 bg-card border-b border-border shrink-0">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="p-4 rounded-xl border border-red-100 bg-red-50/50 flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-red-600 uppercase tracking-wider mb-1">Failure Rate</p>
                <h3 className="text-2xl font-black text-red-700">4.2% <span className="text-sm font-medium text-red-600/70 ml-1">of total</span></h3>
              </div>
            ...
            <div className="p-4 rounded-xl border border-orange-100 bg-orange-50/50 flex items-center justify-between">
              <div>
            ...
            <div className="p-4 rounded-xl border border-blue-100 bg-blue-50/50 flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-black text-blue-700">$311.50 <span className="text-sm font-medium text-blue-600/70 ml-1">Today</span></h3>
              </div>
      ...
      {selectedOrder && (
        <div className="w-full md:w-1/2 bg-card overflow-hidden flex flex-col relative z-20 shadow-[-10px_0_30px_rgba(0,0,0,0.05)] border-l border-border absolute md:static inset-y-0 right-0 h-full">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-border shrink-0 bg-red-50/30">
            <div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-muted/30 p-4 rounded-xl border border-border col-span-2">
