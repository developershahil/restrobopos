          ...
          >
            ...
            <div className="flex-1 flex flex-col h-full bg-background border-r border-border">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                      ...
                      <AnimatePresence>
                        {showVariableMenu && (
                          <motion.div 
                            ...
                            exit={{ opacity: 0, y: 10 }}
                            className="absolute bottom-full right-0 mb-2 w-64 bg-card border border-border rounded-xl shadow-2xl overflow-hidden z-10"
                          >
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <button className="w-full border-2 border-dashed border-border rounded-2xl p-6 flex flex-col items-center justify-center gap-2 hover:border-primary/40 hover:bg-primary/5 transition-all group">
              ...
              <div className="p-4 border-t border-border bg-background flex items-center justify-between sticky bottom-0 z-20">
                <button 
                  onClick={onClose}
                  className="px-6 py-2 border border-border rounded-lg text-xs font-bold hover:bg-muted transition-colors uppercase tracking-widest"
                >
                  Cancel
                </button>
                <button 
            ...
            <div className="w-[360px] bg-muted/20 border-l border-border p-8 flex flex-col items-center justify-center">
              <div className="w-full space-y-6">
                ...
                <div className="relative w-full aspect-[9/19] bg-[#1a1a1a] rounded-[45px] border-[8px] border-[#333] shadow-2xl p-4 flex flex-col overflow-hidden">
                  ...
                  <div className="mt-12 space-y-2">
                    <motion.div 
                      layout
                      className="bg-white/90 backdrop-blur-md rounded-2xl p-3.5 shadow-xl"
                    >
