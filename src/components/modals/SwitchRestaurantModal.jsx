...
export default function SwitchRestaurantModal({ isOpen, onClose, brands, activeBrand, onSelectBrand }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-background/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      {/* Modal Content */}
      <div className="bg-card w-full max-w-2xl rounded-2xl shadow-2xl border border-border flex flex-col relative z-10 overflow-hidden max-h-[85vh] animate-in zoom-in-95 duration-200">
        
        {/* Header */}
        <div className="p-6 border-b border-border bg-muted/30 shrink-0">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-2xl font-black text-foreground">Switch Brand Context</h2>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 bg-background border border-border rounded-xl outline-none focus:border-primary font-medium shadow-sm"
            />
          </div>
        </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-muted-foreground">{brand.role}</p>
                  </div>
                </div>
        ...
        <div className="p-4 sm:p-6 border-t border-border bg-muted/30 shrink-0">
          <button className="w-full py-3 bg-background border border-border border-dashed rounded-xl font-bold text-muted-foreground hover:text-foreground hover:border-primary hover:bg-primary/5 transition-colors flex items-center justify-center gap-2">
            <PlusCircle className="w-5 h-5" /> Register New Restaurant Brand
          </button>
        </div>
