...
const initialItems = [
  ...
  { id: 'i2', name: 'Chicken Wings', price: '14.50', type: 'Non-Veg', status: 'Active', categoryId: 'c1', inStock: true, stockQty: '30', itemCode: 'STR-002', discount: '10', minOrderQty: '1', maxOrderQty: '5', tags: ['Popular'], description: 'Spicy and tangy chicken wings.', prepTime: '20', calories: '450', packagingCharge: '5', allergens: [], channels: ['Delivery','Takeaway','Dine-in'] },
  { id: 'i3', name: 'Butter Chicken', price: '22.00', type: 'Non-Veg', status: 'Active', categoryId: 'c2', inStock: true, stockQty: '20', itemCode: 'MN-001', discount: '0', minOrderQty: '1', maxOrderQty: '5', tags: ['Bestseller'], description: 'Rich tomato gravy with roasted chicken.', prepTime: '25', calories: '600', packagingCharge: '10', allergens: ['Dairy','Nuts'], channels: ['Delivery','Takeaway','Dine-in'] },
  { id: 'i4', name: 'Dal Makhani', price: '16.00', type: 'Veg', status: 'Active', categoryId: 'c2', inStock: true, stockQty: '40', itemCode: 'MN-002', discount: '5', minOrderQty: '1', maxOrderQty: '5', tags: [], description: 'Slow cooked black lentils.', prepTime: '20', calories: '400', packagingCharge: '10', allergens: ['Dairy'], channels: ['Delivery','Takeaway','Dine-in'] },
  { id: 'i5', name: 'Tiramisu', price: '8.50', type: 'Veg', status: 'Active', categoryId: 'c3', inStock: true, stockQty: '15', itemCode: 'DS-001', discount: '0', minOrderQty: '1', maxOrderQty: '10', tags: ['Chef Special'], description: 'Coffee flavored Italian dessert.', prepTime: '10', calories: '350', packagingCharge: '5', allergens: ['Dairy','Egg'], channels: ['Dine-in'] },
  { id: 'i6', name: 'Brownie Sizzler', price: '10.00', type: 'Veg', status: 'Active', categoryId: 'c3', inStock: true, stockQty: '10', itemCode: 'DS-002', discount: '0', minOrderQty: '1', maxOrderQty: '5', tags: [], description: 'Hot brownie with vanilla ice cream.', prepTime: '15', calories: '500', packagingCharge: '5', allergens: ['Dairy','Nuts'], channels: ['Dine-in'] },
  { id: 'i7', name: 'Mojito', price: '6.00', type: 'Veg', status: 'Active', categoryId: 'c4', inStock: true, stockQty: '100', itemCode: 'BV-001', discount: '0', minOrderQty: '1', maxOrderQty: '10', tags: [], description: 'Refreshing lime and mint drink.', prepTime: '5', calories: '150', packagingCharge: '0', allergens: [], channels: ['Delivery','Takeaway','Dine-in'] },
  { id: 'i8', name: 'Iced Latte', price: '5.50', type: 'Veg', status: 'Active', categoryId: 'c4', inStock: false, stockQty: '0', itemCode: 'BV-002', discount: '0', minOrderQty: '1', maxOrderQty: '10', tags: [], description: 'Cold coffee with milk.', prepTime: '5', calories: '200', packagingCharge: '0', allergens: ['Dairy'], channels: ['Delivery','Takeaway','Dine-in'] },
];
...
export const useMenuStore = create((set, get) => ({
  ...
  loading: {},   // { createItem: true, updateMenu: false, ... }
  errors:  {},   // { createItem: 'Name already taken', ... }
  ...
  fetchCategories: () => {
    // Legacy fetching mocked as no-op since data is local
  },
