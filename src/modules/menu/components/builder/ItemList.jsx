...
function SortableItemRow({ item, isSelected, onSelect, onToggleStock, onSnooze, onDuplicate, onMoveCategory, onEdit, onDelete, onMove, openMenuId, setOpenMenuId }) {
  ...
  return (
    <div
      ...
      className={`group px-3 py-2 cursor-pointer transition-colors border-b border-border/50 relative bg-background ${
...
function MoveModal({ item, onSave, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-card border border-border rounded-md shadow-xl w-80 mx-4">
        <div className="px-3 py-2 border-b border-border">
...
function SnoozeModal({ item, onSave, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-card border border-border rounded-md shadow-xl w-80 mx-4 overflow-hidden animate-in fade-in zoom-in-95">
