    ...
    <div className="absolute inset-y-0 right-0 w-full sm:w-[400px] bg-card border-l border-border shadow-2xl z-20 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-border rounded-md p-4 flex flex-col items-center justify-center text-center hover:bg-muted/30 transition-colors cursor-pointer group">
