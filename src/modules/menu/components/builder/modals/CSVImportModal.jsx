...
export default function CSVImportModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-card border border-border rounded-md shadow-2xl w-full max-w-2xl mx-4 flex flex-col max-h-[85vh]">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          {!rows && (
            <div
              ...
              className={`border-2 border-dashed rounded-md py-10 flex flex-col items-center justify-center text-center cursor-pointer transition-colors ${
