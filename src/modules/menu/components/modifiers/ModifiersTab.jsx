      ...
      <div className="flex-1 overflow-auto p-4 bg-background">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {activeModifierTab === 'addons' && filteredAddons.map(group => {
            ...
            return (
              <div key={group.id} className="bg-card border border-border rounded-md shadow-sm hover:border-primary/30 transition-all flex flex-col">
          ...
          {activeModifierTab === 'variants' && filteredVariantGroups.length === 0 && (
            <div className="col-span-full py-12 flex flex-col items-center justify-center text-center">
              ...
              <button 
                onClick={() => setModal({ mode: 'add' })}
                className="mt-4 px-4 py-2 bg-primary text-primary-foreground font-bold rounded-lg hover:bg-primary/90 transition-colors shadow-sm"
              >
