...
import { getAffectedItems, totalRate } from '@modules/menu/utils/taxUtils';
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/50 border-b border-border">
                <th className="text-left px-3 py-2 font-semibold text-muted-foreground">Tax Name</th>
                <th className="text-center px-3 py-2 font-semibold text-muted-foreground">CGST</th>
                <th className="text-center px-3 py-2 font-semibold text-muted-foreground">SGST</th>
                ...
                <th className="text-center px-3 py-2 font-semibold text-muted-foreground">Items</th>
            ...
            <tbody>
              {taxes.map((tax, idx) => (
                <tr key={tax.id} className={`border-t border-border/50 ${idx % 2 ? 'bg-muted/20' : ''}`}>
                  <td className="px-3 py-2 font-semibold text-foreground">{tax.name}</td>
                  ...
                  <td className="px-3 py-2 text-muted-foreground text-sm">{getCategoryNames(tax.categoryIds)}</td>
                  <td className="px-3 py-2 text-center">
