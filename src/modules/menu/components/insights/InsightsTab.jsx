  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden relative">
      <div className="p-4 border-b border-border bg-card shrink-0">
        <h2 className="text-lg font-bold text-foreground">Menu Insights</h2>
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {/* Top Performers */}
          <div className="bg-card border border-border rounded-md shadow-sm p-5 flex flex-col">
            <div className="flex items-center gap-2 mb-4 text-green-600">
              <div className="p-2 bg-green-50 rounded-lg"><TrendingUp className="w-4 h-4" /></div>
          ...
          <div className="bg-card border border-border rounded-md shadow-sm p-5 flex flex-col">
            <div className="flex items-center gap-2 mb-4 text-red-600">
              <div className="p-2 bg-red-50 rounded-lg"><TrendingDown className="w-4 h-4" /></div>
          ...
          <div className="bg-card border border-border rounded-md shadow-sm p-5 flex flex-col">
            <div className="flex items-center gap-2 mb-4 text-orange-600">
              <div className="p-2 bg-orange-50 rounded-lg"><EyeOff className="w-4 h-4" /></div>
            ...
            <div className="flex-1 space-y-4">
              ...
              {mockInsights.hidden.map((item, i) => (
                <div key={i} className="flex justify-between items-center pb-4 border-b border-border last:border-0 last:pb-0 bg-muted/30 p-3 rounded-lg">
                  ...
                  <button className="text-primary hover:text-primary/80"><ArrowRight className="w-4 h-4" /></button>
                </div>
              ))}
            </div>
          </div>
