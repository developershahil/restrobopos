  ...
  return (
    <div className="flex h-full flex-col md:flex-row">
      ...
      <div className={`${selectedCustomer ? 'flex' : 'hidden md:flex'} flex-1 bg-card overflow-y-auto flex-col`}>
        {selectedCustomer ? (
          <div className="p-4 md:p-4 max-w-3xl mx-auto w-full">
            {/* Customer Header */}
            ...
            <div className="mb-6 p-5 bg-background border border-border rounded-md">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                          <span className="font-bold text-[13px] text-foreground">{order.id}</span>
