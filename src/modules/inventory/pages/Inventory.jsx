...
import InventoryHeader from '@modules/inventory/components/common/InventoryHeader';
import IngredientsTab from '@modules/inventory/components/ingredients/IngredientsTab';
import RecipesTab from '@modules/inventory/components/recipes/RecipesTab';
import RecipeCostTab from '@modules/inventory/components/recipes/RecipeCostTab';
import StockLevelsTab from '@modules/inventory/components/stock/StockLevelsTab';
import StockLedgerTab from '@modules/inventory/components/stock/StockLedgerTab';
import VendorsTab from '@modules/inventory/components/purchase/VendorsTab';
