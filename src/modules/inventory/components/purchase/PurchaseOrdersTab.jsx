    ...
    <div className="h-full flex flex-col bg-card">
      ...
      <div className="flex-1 overflow-y-auto">
        <EmptyState 
          ...
          action={
            <button className="flex items-center gap-2 px-3 py-2 bg-background border border-border text-foreground font-bold rounded-md shadow-sm hover:bg-muted transition-colors mt-4">
