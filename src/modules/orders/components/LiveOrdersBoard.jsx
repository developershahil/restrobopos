    ...
    <div className="flex h-full bg-background relative overflow-hidden flex-col md:flex-row">
      ...
      <div className={`${selectedOrder ? 'hidden md:flex' : 'flex'} w-full md:w-1/3 md:min-w-[350px] border-r border-border bg-card flex-col z-10 shadow-sm`}>
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-2 bg-background/50">
          {paginatedOrders.length === 0 ? (
            <div className="text-center p-5 text-muted-foreground">No orders found.</div>
          ) : (
      ...
      <div className={`${selectedOrder ? 'flex' : 'hidden md:flex'} flex-1 bg-background overflow-hidden flex-col relative`}>
        {selectedOrder ? (
          <>
            {/* Header */}
            <div className="flex items-center justify-between p-4 md:p-4 border-b border-border bg-card shrink-0 shadow-sm z-10">
              <div>
                <button 
            ...
            <div className="flex-1 overflow-y-auto p-3 md:p-4 lg:px-6 space-y-4 mx-auto w-full max-w-5xl">
              ...
              <div className="bg-card p-4 rounded-md flex items-start gap-3 border border-border shadow-sm">
                <div className="bg-muted p-2.5 rounded-full"><User className="w-4 h-4 text-muted-foreground" /></div>
                <div>
              ...
              {selectedOrder.type === 'Delivery' && selectedOrder.status === 'Ready' && (
                <div className="bg-blue-50/50 p-4 rounded-md border border-blue-100 shadow-sm">
