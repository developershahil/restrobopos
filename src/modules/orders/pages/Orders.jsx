...
import LiveOrdersBoard from '@modules/orders/components/LiveOrdersBoard';
import PastOrdersTable from '@modules/orders/components/PastOrdersTable';
import FailedOrdersTable from '@modules/orders/components/FailedOrdersTable';
      ...
      <div className="flex items-center p-2 border-b border-border bg-muted/30 shrink-0 gap-4 justify-center overflow-x-auto">
        <div className="flex bg-card p-1 rounded-lg shadow-sm border border-border min-w-max">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-md font-bold text-sm transition-all ${
              activeTab === 'live' 
