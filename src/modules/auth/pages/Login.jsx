    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background overflow-hidden font-sans">
      ...
      <div className="relative w-full md:w-1/2 lg:w-3/5 h-64 md:h-screen bg-neutral-900 overflow-hidden">
        ...
        <div className="absolute top-5 left-8 z-20 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white tracking-tight leading-none">Restrobopos</h2>
            <p className="text-primary text-[10px] font-black uppercase tracking-[0.2em] mt-1">Management Suite</p>
          </div>
        </div>

        {/* Content Container */}
        <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-16 lg:p-24 z-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-5 md:p-16 lg:p-24 bg-card relative">
        ...
        <div className="w-full max-w-md space-y-10 relative z-10">
          <div className="space-y-3">
            ...
            <h1 className="text-2xl font-bold text-foreground tracking-tight leading-none">Welcome Back</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-5">
              <div className="space-y-2">
                <label className="text-[13px] font-medium text-foreground">Business Email</label>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-4 py-2 bg-background border border-border rounded-md outline-none focus:border-primary transition-all font-medium text-[13px]"
                  />
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 ml-1">
              ...
              <label htmlFor="remember" className="text-[13px] font-medium text-muted-foreground cursor-pointer">Remember this device</label>
            </div>

            <button 
              type="submit" 
              className="w-full group relative flex items-center justify-center gap-3 h-9 bg-primary text-primary-foreground rounded-md font-medium text-[13px] shadow-sm hover:scale-[1.02] active:scale-[0.98] transition-all overflow-hidden"
            >
