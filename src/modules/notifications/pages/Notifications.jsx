  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-foreground tracking-tight">Send Notification</h1>
          <p className="text-sm font-bold text-muted-foreground">Manage and broadcast push notifications to your customers</p>
        </div>
        <button 
          onClick={handleCreateNew}
          className="flex items-center justify-center gap-2 px-3 py-2 bg-primary text-primary-foreground rounded-lg font-black shadow-lg shadow-primary/20 hover:scale-105 transition-all"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="bg-card border border-border p-5 rounded-lg flex items-center gap-4 shadow-sm">
      ...
      {/* Filter Bar */}
      <div className="flex flex-col md:flex-row gap-4 bg-card border border-border p-4 rounded-lg shadow-sm">
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full bg-muted/50 border border-border rounded-md py-2.5 pl-10 pr-4 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
          />
        </div>
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-2 px-4 py-2.5 bg-muted/50 border border-border rounded-md text-sm font-bold hover:bg-muted transition-colors">
            <Filter className="w-4 h-4" />
            <span>Filter</span>
          </button>
          <button className="flex items-center gap-2 px-4 py-2.5 bg-muted/50 border border-border rounded-md text-sm font-bold hover:bg-muted transition-colors text-primary">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-muted/30 border-b border-border">
                <th className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Title & Description</th>
                <th className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Created At</th>
                <th className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Screen</th>
                <th className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground">Status</th>
                <th className="px-3 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground text-right">Actions</th>
              </tr>
            </thead>
