    ...
    <div className="p-4 max-w-full mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="flex bg-card border border-border rounded-lg p-1">
          ...
          <div className="relative" ref={dateRef}>
            <button 
              ...
              className={`flex items-center gap-2 px-3 h-8 flex items-center justify-center text-[13px] font-medium rounded-md transition-colors ${timeFilter === 'Custom' ? 'bg-background shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
            >
        ...
        <button 
          ...
          className={`px-3 h-8 flex items-center justify-center text-[13px] font-medium rounded-md border transition-colors flex items-center gap-2
      ...
      <div className={compareMode ? "grid grid-cols-2 gap-4" : ""}>
        ...
        <div className="space-y-6">
          {compareMode && (
            <div className="border-b border-border pb-2">
              <select className="text-[15px] font-semibold bg-transparent outline-none cursor-pointer hover:bg-muted p-1 rounded-md transition-colors w-full max-w-xs">
          ...
          <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-2">Order Type Breakdown</h3>
          ...
          <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider pt-2">Deep Insights</h3>
        ...
        {compareMode && (
          <div className="space-y-6 border-l border-border pl-6">
            <div className="border-b border-border pb-2">
              <select 
                className="text-[15px] font-semibold bg-transparent outline-none cursor-pointer hover:bg-muted p-1 rounded-md transition-colors w-full max-w-xs" 
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-card border border-border rounded-md p-3 flex items-center gap-4 opacity-80">
              ...
              <div className="bg-card border border-border rounded-md p-3 flex items-center gap-4 opacity-80">
                <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-orange-100 text-orange-500">
...
function KPICard({ title, value, icon: Icon, trend, trendUpIsBad = false }) {
  ...
  return (
    <div className="bg-card p-4 rounded-md border border-border shadow-sm flex flex-col justify-between">
...
function ChartPlaceholder({ title, icon: Icon, desc }) {
  return (
    <div className="bg-card border border-border rounded-lg p-5 flex flex-col h-40">
