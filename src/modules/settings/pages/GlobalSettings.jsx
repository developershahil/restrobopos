...
const InputGroup = ({ label, value, onChange, placeholder, type = "text", subtext }) => (
  <div className="space-y-1.5">
    ...
    <input 
      ...
      className="w-full px-4 py-2.5 bg-muted/10 border border-border rounded-md text-sm font-medium outline-none focus:border-primary transition-all"
    />
    ...
    <div className="flex flex-col h-full bg-muted/10 overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-1 scrollbar-hide">
            {SECTIONS.map(section => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm font-bold transition-all ${
                  activeSection === section.id 
                    ? 'bg-primary/10 text-primary shadow-sm' 
                    : 'text-muted-foreground hover:bg-muted hover:text-foreground'
                }`}
              >
                <section.icon className={`w-4 h-4 ${activeSection === section.id ? 'text-primary' : 'text-muted-foreground'}`} />
                {section.label}
              </button>
            ))}
          </div>
        ...
        <div className="flex-1 overflow-y-auto bg-muted/5 relative">
          <div className="max-w-4xl mx-auto p-4 md:p-10 space-y-6 pb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2.5 bg-muted/10 border border-border rounded-md text-sm font-bold outline-none focus:border-primary"
                    />
                  </div>
                </div>
                  ...
                  <div className="p-4 space-y-6">
                    <div className="space-y-1.5">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-2.5 bg-muted/10 border border-border rounded-md text-sm font-bold outline-none focus:border-primary appearance-none cursor-pointer"
                      >
                    ...
                    <div className="border-2 border-dashed border-border rounded-lg p-12 text-center hover:border-primary transition-colors cursor-pointer group">
                      <div className="w-16 h-16 bg-muted/20 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-card border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="h-40 bg-muted/10 border border-border border-dashed rounded-md flex items-center justify-center relative group">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 relative">
                        <input 
                          ...
                          className="w-full pl-4 pr-12 py-2.5 bg-muted/10 border border-border rounded-md text-sm font-bold outline-none focus:border-primary"
                        />
                ...
                <div className="bg-card border border-border rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    {settings.brand.showEnquiryBanner && (
                      <div className="border-2 border-dashed border-border rounded-md p-5 text-center hover:border-primary transition-colors cursor-pointer group animate-in slide-in-from-top-2 duration-300">
                        <div className="w-12 h-12 bg-muted/20 rounded-md flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                          <ImageIcon className="text-muted-foreground group-hover:text-primary" />
                        </div>
            ...
            {activeSection === 'sms' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-1">
                  <h2 className="text-xl font-bold text-foreground">SMS Gateway</h2>
            ...
            {activeSection === 'maps' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-1">
                  <h2 className="text-xl font-bold text-foreground">Maps & Geolocation</h2>
                  <p className="text-sm text-muted-foreground">Integrate map services for deliveries and store tracking.</p>
                </div>
                <div className="bg-card border border-border rounded-lg p-4 space-y-6">
                  <div className="flex items-center gap-4 p-4 bg-[#4285F4]/5 rounded-md border border-[#4285F4]/20">
                    <div className="w-12 h-12 bg-[#4285F4]/10 rounded-md flex items-center justify-center text-[#4285F4]">
                      <MapPin />
                    </div>
                    <div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-card border border-border rounded-lg p-4 space-y-6">
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      className="w-full h-72 px-3 py-2 bg-muted/10 border border-border rounded-md text-sm font-medium outline-none focus:border-primary resize-none transition-all"
            ...
            {activeSection === 'cashback' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-1">
                  <h2 className="text-xl font-bold text-foreground">Cashback Configuration</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div className="space-y-1.5">
                             ...
                             <div className="flex gap-2">
                               <input type="number" className="w-full px-4 py-2 bg-muted/10 border border-border rounded-md text-sm font-bold outline-none" placeholder="Hrs"
                               ...
                               <input type="number" className="w-full px-4 py-2 bg-muted/10 border border-border rounded-md text-sm font-bold outline-none" placeholder="Mins"
            ...
            {activeSection === 'ordering' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <h2 className="text-xl font-bold text-foreground">Ordering Modes</h2>
                    <p className="text-sm text-muted-foreground">Manage how customers place orders.</p>
                  </div>
                  <button 
                    onClick={() => setShowOrderingModal(true)}
                    className="flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-black rounded-md shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all"
                  >
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="bg-muted/20 border-b border-border">
                        <th className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Name</th>
                        <th className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Type</th>
                        <th className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Order Tab</th>
                        <th className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest text-center">Status</th>
                        <th className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase tracking-widest text-right">Actions</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-border">
                      {settings.orderingMode.map(mode => (
                        <tr key={mode.id} className="hover:bg-muted/5 transition-colors group">
                          <td className="px-3 py-2 font-bold text-foreground">{mode.name}</td>
                          <td className="px-3 py-2">
                             <span className="px-2 py-1 bg-muted/20 rounded-lg text-[10px] font-black uppercase text-muted-foreground">{mode.type}</span>
                          </td>
                          <td className="px-3 py-2 text-sm font-bold text-muted-foreground">{mode.orderTab}</td>
            ...
            {activeSection === 'membership' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-1">
                  <h2 className="text-xl font-bold text-foreground">Club Membership</h2>
                  ...
                  <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
                        ...
                        {['All Outlets', 'Main Branch', 'Downtown', 'Airport', 'Mall Kiosk'].map(outlet => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center gap-1.5 px-4 py-2 rounded-md border text-xs font-bold transition-all ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-card border border-border rounded-lg p-4 space-y-4">
                        ...
                        <div className="h-32 bg-muted/10 border border-border border-dashed rounded-md flex items-center justify-center">
            ...
            {activeSection === 'login' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-1">
                  <h2 className="text-xl font-bold text-foreground">Login Restrictions</h2>
      ...
      {saveSuccess && (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-8 duration-500">
          <div className="bg-green-600 text-white px-3 py-2 rounded-lg shadow-2xl flex items-center gap-3">
      ...
      {/* Global Action Bar */}
      {isPageDirty && (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-full max-w-xl px-4 z-50 animate-in slide-in-from-bottom-8 duration-500">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-card w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 border border-border">
            <div className="p-5 border-b border-border flex justify-between items-center bg-muted/20">
              ...
              <button onClick={() => setShowOrderingModal(false)} className="text-muted-foreground hover:text-foreground p-2 hover:bg-muted rounded-md transition-colors"><X size={20} /></button>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-4">
                  {['DSR', 'Fine Dine'].map(type => (
                    <label key={type} className="flex-1 flex items-center justify-center gap-2 p-3 rounded-md border border-border cursor-pointer hover:border-primary transition-all has-[:checked]:bg-primary/5 has-[:checked]:border-primary">
            ...
            <div className="p-5 border-t border-border flex justify-end gap-3 bg-muted/5">
              <button className="px-4 py-2.5 text-xs font-black text-muted-foreground hover:bg-muted rounded-md transition-colors" onClick={() => setShowOrderingModal(false)}>Cancel</button>
              <button 
                className="px-8 py-2.5 text-xs font-black bg-primary text-primary-foreground hover:bg-primary/90 rounded-md shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition-all"
                onClick={() => {
